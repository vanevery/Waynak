...
import org.waynak.hackathon.RecentAdapter.ViewHolder;
...
public class PlacesAdapter extends ArrayAdapter<String> {
	...
	public PlacesAdapter(Activity context, String [] event ,String [] i) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			...
			holder.eventView = (TextView) rowView.findViewById(R.id.placeTv);
			holder.imageView=(ImageView)rowView.findViewById(R.id.placesImg);
			rowView.setTag(holder);
		} else {
			holder = (ViewHolder) rowView.getTag();
		}
		
		String t = placeName[position];
